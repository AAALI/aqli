/**
 * Composio webhook route — retained as a commented reference, not routed.
 *
 * Replaced by app/api/integrations/github/webhook/route.ts. Same shape
 * (verify, claim, ack, process in background); GitHub's payload in place of
 * Composio's envelope.
 *
