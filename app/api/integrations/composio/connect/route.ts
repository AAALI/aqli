/**
 * Composio connect route — retained as a commented reference, not routed.
 *
 * Replaced by app/api/integrations/github/connect/route.ts, which takes a pasted
 * token instead of starting a hosted OAuth flow.
 *
