/**
 * Composio callback route — retained as a commented reference, not routed.
 *
 * No replacement. This existed only to receive Composio's OAuth redirect;
 * the token flow has nothing to come back from.
 *
